Ext.define('SenchaExample.util.Splashscreen', {
    ...
    show: function (title = 'Sencha', msg = 'Loading...') {
        ...
        // If there is a mask, then we will update the content (if necessary) and exit
        ...
        var html = Splashscreen.getSplashscreen() + '<div class="x-coresplash-title">' + title + '</div>' +
            '<div class="x-coresplash-message">' + msg + '</div>';
